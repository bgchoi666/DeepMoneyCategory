...
model_name = 'transfer_LSTM2-고저점-1'
channel = False
...
checkpoint_path = model_name + "/60M_input36_sample1923"
checkpoint_path_best = model_name + "/60M_input36_sample1923_best"
...
def train():
    ...
    while repeat_cnt < max_repeat_cnt:
        ...
        if repeat_cnt > 1:
            train_x, _, train_y, _ = train_test_split(np.concatenate([train_x, best_x]),
                                                      np.concatenate([train_y, best_y]), test_size=0.5)
