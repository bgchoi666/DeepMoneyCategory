...
class GenerateResult():
    ...
    def save_result(self,model_name,item_name,n_units,target_type,batch_size,n_timestep,time_interval,epochs,alpha,comment):
        ...
        sheet1.cell(9,13,'실재 예측일')
        sheet1.cell(10,13,'Transfer day')
        sheet1.cell(11,13,'epochs')
        sheet1.cell(12,13,'alpha')
        sheet1.cell(13,13,'commnent')
        sheet1.cell(14,13,'datetime')
        ...
        sheet1.cell(9,14, -self.train_end_back)
        sheet1.cell(10,14, self.trans_day)
        sheet1.cell(11,14, epochs)
        sheet1.cell(12,14, alpha)
        sheet1.cell(13,14, comment)
        sheet1.cell(14,14, datetime.now().strftime('%Y-%m-%d-%H:%M:%S'))
