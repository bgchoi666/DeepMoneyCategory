        ...
        for future_day in future_days:
            ...
            for n_timestep in n_timesteps:
                for time_interval in time_intervals:
                    ...
                    model = models.ResLSTM2noise(n_timestep,input_size,n_unit,regularizers_alpha=0.01,drop_rate=0.5)
                    ...
                    test_prediction = learn.predict_batch_test(model, test_x,100)
