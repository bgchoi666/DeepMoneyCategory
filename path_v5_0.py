...
#data file name
file_name = "../DeepMoneyData/kospi200f_19961220_20061231.csv"
market = "kospi200f"
...
class Config(object):
    ...
    alpha = 0.1 # the weight of RRL loss
    beta = 0.2 # the weight of kelly loss in non-gradual mode

    model_reset = True
    shuffle = True

    train_start1 = "1996-12-20"
    train_end1 = "2006-12-31"

    train_start2 = "1996-12-20"
